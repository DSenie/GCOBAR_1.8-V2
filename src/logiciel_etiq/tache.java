...
private JLabel lab_combo=new JLabel("Tache_Intitul�");
private	JTextField tache=new JTextField();
private	JLabel intitule_lab=new JLabel("Intitul�");
    ...
    but_sup.addActionListener(
  	...
  	valid_supp.addActionListener(
          ...
          tach.tache(intitule.getText());
           ...
           if(tache_comb.getSelectedIndex()==0){
	      				msg+="Vous Devez D'abord S�lectionner un Tache \n";
          }
           ...
           if(!msg.equals("")){
  	       ...
  	       tache_comb.addItem("---S�lectionner une Tache-----");
...
//              else{
  	...
  	valid_modif.addActionListener(
	            ...
	            desc=false;
	            if(tache_comb.getSelectedIndex()==0){
	                msg+="Vous Devez D'abord S�lectionner une Tache \n";
	        	  	                                    }
	            else if(intitule.getText().equals("")) {	
	                msg+="Veuillez remplir l'intitul� \n";
	            	 	}
	            if(!msg.equals("")){
 		  	           JOptionPane.showMessageDialog(null,msg);                                                                            
 		  	            	}
	    	          ...
	    	          JOptionPane.showMessageDialog(null,"La Tache a �t� bien modifi�");
	    	          intitule.setText("");
	    	          tache_comb.removeAllItems();
	    	          tache_comb.addItem("---S�lectionner une Tache-----");
	    	          list_tache_tr=tach.select_tache_code();
  	 ...
  	 but_sauv.addActionListener(
             ...
             public void actionPerformed(ActionEvent e) {
              ...
              if(tach.ex==true){
              	 JOptionPane.showMessageDialog(null, "Cette Tache existe d�j�", "",
              	 JOptionPane.INFORMATION_MESSAGE);
              	   but_sauv.setVisible(false);
                   but_modif.setVisible(true);
                   but_sup.setVisible(true);
   ...
   valid_ajou.addActionListener(
           ...
           public void actionPerformed(ActionEvent e) {
        	...
        	if(intitule.getText().equals("")) {	desc=true;
                   msg+="Veuillez remplir l'intitul� \n";}
        	else if (tach.ex==true) {msg+="Cette Tache existe d�j� \n";}
        	else{
           ...
           if(exist==false&&desc==false&&tach.ex==false){
        	   JOptionPane.showMessageDialog(null,"La Tache a �t� bien ajout�");
        	   tache_comb.enable();
               intitule.setText("");
           }
