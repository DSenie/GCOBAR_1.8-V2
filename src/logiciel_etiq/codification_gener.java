  	...
  	valid_modif.addActionListener(
	            ...
	            public void actionPerformed(ActionEvent e) {
	            	   ...
	            	   if(famille_comb.getSelectedIndex()==0){
	        	      				...
	        	      				msg+="Vous Devez D'abord S�lectionner une famille \n";
	            	 	...
	            	 	if(!msg.equals("")){
	    	            	...
	    	            	famil.setupdate_famille(famille.getText(), designation.getText());
	    	            	 JOptionPane.showMessageDialog(null,"La famille a �t� bien modifier");
	   	    	          designation.setText("");
		    	          famille.setText("");
  	 ...
  	 but_sauv.addActionListener(
             ...
             public void actionPerformed(ActionEvent e) {
                ...
                if(existe==true){
                	 JOptionPane.showMessageDialog(null, "Cette famille existe d�ja", "",
                	 JOptionPane.INFORMATION_MESSAGE);
                	   but_sauv.setVisible(false);
           ...
           public void actionPerformed(ActionEvent e) {
              ...
              // famil.famille(designation.getText(),famille.getText());
                ...
                msg+="Veuillez remplir le code famille \n";}
        	 	else if (existe==true) {msg+="Cette famille existe d�ja \n";}
        	 	else{
        	 ...
        	 famille_comb.removeAllItems();
        	 	 ...
        	 	 if(desc==false&&existe==false){
              	   JOptionPane.showMessageDialog(null,"La famille a �t� bien ajouter");
              	  famille_comb.enable();
                     designation.setText("");
                     famille.setText("");
