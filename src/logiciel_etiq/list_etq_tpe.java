...
public class list_etq_tpe extends JFrame {
	/**
	 * 
	 */
    ...
    Object [] entete={"Code/Designation","mod�le","Code TPE","ARPT","Date"};
	...
	list_etq_tpe(final String log) throws ParseException{
	   ...
	   public void composant() throws ParseException{
		   ...
		   tab.setStyle(2);
			...
			//  imp.select_portable();
			  list_fiche=imp.select_etq_tpe();
			  System.out.println("rrrrrrr" +list_fiche);
		  ...
		  //   popupMenu.add(menuItem2);
	                  ...
	                  public void actionPerformed(ActionEvent e) {
	                	   att = new Thread(){
		  						...
		  						Date actuelle=new Date();
			 	                  DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
			 					   date_jour = dateFormat.format(actuelle);
			 	          			...
			 	          			String parcour="C://GCOBAR//pdf//excel//tpe_etiquette"+date_jour+".xlsx";
		 	        		...
		 	        		worksheet.write(fileOut);
	 			          	fileOut.close();
	 			          	fileOut.flush();
	  					    BufferedReader bfr=	new BufferedReader(new FileReader("C://GCOBAR//pdf//excel//tpe_etiquette"+date_jour+".xlsx"));
	  					     bfr.close();		
	  						 					try {
	  		            	 Desktop.getDesktop().open(new File( "C://GCOBAR//pdf//excel//tpe_etiquette"+date_jour+".xlsx"));
		     ...
		     menuItem.addActionListener(
	                  ...
	                  public void actionPerformed(ActionEvent e) {
	                	  ...
	                	  if(selectedRow!=-1){
	                		  String parcour= "C:\\GCOBAR\\pdf\\etq_tpe\\"+dimension_comb.getSelectedItem()+listrc.get(0).toString().replaceAll("\\/", "_")
	                				  +"_"+listrc.get(z-1).toString().replaceAll("\\/", "_")+"_"+z+"_"+"etq_tpe.pdf";
								String model ="C:\\GCOBAR\\CODE\\"+report;
	                		  try{

                            new BufferedReader(new FileReader("C:\\GCOBAR\\pdf\\etq_tpe\\"+dimension_comb.getSelectedItem()+listrc.get(0).toString().replaceAll("\\/", "_")
	                				  +"_"+listrc.get(z-1).toString().replaceAll("\\/", "_")+"_"+z+"_"+"etq_tpe.pdf"));
	                			  try {
	    	                		  Desktop.getDesktop().open(new File("C:\\GCOBAR\\pdf\\etq_tpe\\"+dimension_comb.getSelectedItem()+listrc.get(0).toString().replaceAll("\\/", "_")
	                				  +"_"+listrc.get(z-1).toString().replaceAll("\\/", "_")+"_"+z+"_"+"etq_tpe.pdf"));
	                                 ...
	                                 selectioncomb.imprimer("code_tpe",listrc, bdd, parcour,model);
	                                 listrc.clear();
