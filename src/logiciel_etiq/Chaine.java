...
private Object [] entete={"Code/D�signation Zone","D�signation"};
...
public void composant(final String log){
	  tab.allowEdition1=false;
      final  Font police2 = new Font("Comic Sans MS", Font.BOLD|Font.ITALIC,18);
	  list_c = new ArrayList<Object>(Arrays.asList(new String[]{"--S�lectionner une Chaine--"}));
	...
	valid_supp.addActionListener(
           ...
           // use.select_chaine_jtext(designation.getText());
            ...
            if(chaine_comb.getSelectedIndex()==0){
	          msg+="Vous Devez d'abord S�lectionner une Chaine \n";
	         }
            else if(existe==true){
  	 ...
  	 but_supprim.addActionListener(
             ...
             JOptionPane.showMessageDialog(null, "Vous devez d'abord s�lectionner la zone que vous voulez supprimer", "",
     	 	 JOptionPane.INFORMATION_MESSAGE);
                	                           }
             else{
  	...
  	valid_modif.addActionListener(
		       ...
		       // use.select_chaine_jtext(designation.getText());
		        ...
		        use.setupdate_chaine_tab_delete(zone_fi.getText());
		  		...
		  		else if(repet2==true){ msg+="Il existe une ou plusieurs zones dupliqu�es \n"; }
		  		
		  		if(!msg.equals("")){JOptionPane.showMessageDialog(null,msg); }
		  		
		  		else{
		  	    JOptionPane.showMessageDialog(null,"La Chaine a �t� bien modifi�");
		  	    designation.setText("");
		  		chaine_comb.removeAllItems();
		  		chaine_comb.addItem("--S�lectionner une Chaine--");
		  		list_chaine_tr=use.select_chaine_code();
 	       ...
 	       if(existe==false){
 	        ...
 	        if(vaidCheck()==false){valid=true; }
 	    	 if(valid==false)
               ...
               if(repet==false&&desc==false&&valid==false   ) {
                JOptionPane.showMessageDialog(null,"La cha�ne a �t� bien ajout�e");
                designation.setText("");
                chaine_comb.enable();
			   ...
			   for(int i=0;i<list_chaine_tr.size();i++)
			   {
	  		 	...
	  		 	else if(repet==true){msg+="Il existe plusieurs ou des zones dupliqu�es. \n";}
		  		if(!msg.equals("")){JOptionPane.showMessageDialog(null,msg);}
	  		   }}});
          ...
          // if(zone_comb.hasFocus()){ 
        	...
        	if(zone_comb.getSelectedIndex()!=0){
        		 System.out.println("eeeeee�");
                  ...
                  String part1 = parts[0]; // 004
                  System.out.println("eeeeee�"+part1);
