...
//	     			article_comb.enable();
   ...
   String msg="";
	...
	private JCheckBox code_ref = new JCheckBox("Code r�f�rence");
	private JCheckBox code_gener = new JCheckBox("Code g�nerique");
 ...
 final Font police= new Font("Comic Sans MS", Font.BOLD | Font.ITALIC,13);
	...
	pan.setBorder(titl2);
		...
		TitledBorder titlimp = new TitledBorder(border, "Imprim�",
				TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION,
				police2, Color.white);
		...
		public void actionPerformed(ActionEvent e) {
	      ...
	      nom_p.addActionListener(
	             ...
	             public void actionPerformed(ActionEvent e) {
	            	...
	            	if (prof.poste.equals("1")){poste.setSelected(true); }   
	     			if (prof.edit_poste.equals("1")){edit_poste.setSelected(true); }
	     			if (prof.list_poste.equals("1")){list_poste.setSelected(true); }   
	     			if (prof.chaine.equals("1")){chaine.setSelected(true); }   
	     			if (prof.edit_chaine.equals("1")){edit_chaine.setSelected(true); }   
	     			else {edit_chaine.setSelected(false); }
	     			if (prof.list_chaine.equals("1")){list_chaine.setSelected(true); }  
	     			if (prof.chang_chaine.equals("1")){chang_chaine.setSelected(true); } 
	     			else{chang_chaine.setSelected(false); }
	     			if (prof.zone.equals("1")){zone.setSelected(true); } 
	     			else{zone.setSelected(false); }
	     			if (prof.personelle.equals("1")){perso.setSelected(true); }  
	     			else{perso.setSelected(false); }
	     			if (prof.edit_personelle.equals("1")){edit_perso.setSelected(true); }  
	     			else{edit_perso.setSelected(false); }
	     			if (prof.list_personelle.equals("1")){list_perso.setSelected(true); }   
	     			else{list_perso.setSelected(false); }
	     			if (prof.user.equals("1")){user.setSelected(true); }  
	     			else{user.setSelected(false); }
	     			if (prof.edit_user.equals("1")){edit_user.setSelected(true); }
	     			else{edit_user.setSelected(false); }
	     			if (prof.list_user.equals("1")){list_user.setSelected(true); }  
	     			else{list_user.setSelected(false); }
	     			if (prof.profil.equals("1")){profil_user.setSelected(true); } 
	     			else{profil_user.setSelected(false); }
	     			if (prof.code.equals("1")){code.setSelected(true); }  
	     			else{code.setSelected(false); }
	     			if (prof.code_ref.equals("1")){code_ref.setSelected(true); } 
	     			else{code_ref.setSelected(false); }
	     			if (prof.code_gener.equals("1")){code_gener.setSelected(true); }  
	     			else{code_gener.setSelected(false); }
	     			if (prof.code_rech.equals("1")){rech.setSelected(true); }  
	     			else{rech.setSelected(false); }
	     			if (prof.article.equals("1")){article.setSelected(true); }  
	     			else{article.setSelected(false); }
	     			if (prof.edit_article.equals("1")){edit_article.setSelected(true); } 
	     			else{edit_article.setSelected(false); }
	     			if (prof.type.equals("1")){type.setSelected(true); }  
	     			else{type.setSelected(false); }
	     			if (prof.imprime.equals("1")){imprime.setSelected(true); } 
	     			else{imprime.setSelected(false); }
	     			if (prof.etiquette.equals("1")){etq.setSelected(true); }  
	     			else{etq.setSelected(false); }
	     			if (prof.fiche.equals("1")){fiche.setSelected(true); }  
	     			else{fiche.setSelected(false); }
	     			if (prof.list_fiche.equals("1")){list_fiche.setSelected(true); }  
	     			else{list_fiche.setSelected(false); }
	     			if (prof.fourniss.equals("1")){fourniss.setSelected(true); }  
	     			else{fourniss.setSelected(false); }
	     			if (prof.edit_fourniss.equals("1")){edit_fourniss.setSelected(true); }  
	     			else{edit_fourniss.setSelected(false); }
	     			if (prof.list_fourniss.equals("1")){list_fourniss.setSelected(true); }  
...
//			article_comb.enable();
	...
	valid_modif.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			if(i<2){msg+="veuillez cocher au moins 2 case \n";}
			...
			else if(prof.ex==false){msg+="le nom du profil ne peut pas �tre modifi� \n";}
			  if(msg.equals("")){
			  ...
			  if(prof.exist==false)
			 JOptionPane.showMessageDialog(null,"Le profils a �t� bien modifi�e");
			  }
	...
	valid_ajou.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			prof.ajouter_profils(p,ep,lp,c,ec,lc,ch,z,pers,epers,lpers,us,eus,lus,profil,
					...
					im,et,fi,lfi,nom_p.getText(),four,efour,lfour);
			  if(prof.exist==false)
			 JOptionPane.showMessageDialog(null,"Le profils a �t� bien ajout�e");
			  }
			  else{JOptionPane.showMessageDialog(null,msg);}
