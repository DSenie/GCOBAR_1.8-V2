...
public class AutoCompleteComboBox_jcomb extends PlainDocument {
    ...
    public AutoCompleteComboBox_jcomb(final JComboBox comboBox) {
    ...
    private void highlightCompletedText(int start) {
      //System.out.println(getLength()+" "+start+"rrr"+editor.getCaretPosition());
...
//          }
    ...
    int p=  getLength();
      int g= editor.getCaretPosition();
      //  System.out.println("eeeeee"+getLength()+" gggg"+g);
    ...
    private static void createAndShowGUI() {
        ...
        new AutoCompleteComboBox_jcomb(comboBox);
