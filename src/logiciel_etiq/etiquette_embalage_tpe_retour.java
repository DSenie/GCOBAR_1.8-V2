...
/********************************µ LA PALETTE TP0000000 EST AJOUTER A LA BDDD POR EVITER LES CAS DE L4AVANT PALETTE**********/


public class etiquette_embalage_tpe_retour extends JFrame implements ActionListener {
    ...
    private Object[] entete = {"N°","Code IMEI1/ID" ,"Serial Number"};
    ...
    etiquette_embalage_tpe_retour(final String log) {
    ...
    public void composant(final String log) {
        ...
        select_palette=imp.select_palette("PTR");
        ...
        palette_ajou.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                Calendar cal = Calendar.getInstance();
                String aff=imp.afficher_conteur_palette("PTR",chaine_comb.getSelectedItem().toString().substring(2,3));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!msg.equals("")) {
                    ...
                    for (int i = 0; i < tab.table.getRowCount(); i++) {
                        ...
                        imp.update_emei_tpe(parcel_jtext.getText(),tab.table.getValueAt(i, 1).toString(), tab.table.getValueAt(i, 2).toString());
                    }
...
//              use.select_zone_jtext(designation.getText());
                ...
                else if(imp.exist_emballage(parcel_jtext.getText(),"imp_emballage_tpe"))
                ...
                if (!msg.equals("")) {
                    ...
                    for(int i=0;i<tab.table.getRowCount();i++){
                        imp.ajout_emei_tpe(parcel_jtext.getText(),tab.table.getValueAt(i,1).toString(),
        ...
        rech_jtext.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(!parcel_jtext.getText().equals("")){
                    System.out.println("marahach"+imp.exist_emballage_tpe(rech_jtext.getText()));
                    ...
                    if(imp.exist_emballage_tpe(rech_jtext.getText())==true){
                        ...
                        System.out.println("palette "+imp.palette);

                        palette_comb.setSelectedItem(imp.palette);

                        System.out.println(imp.palette);
                        palette_comb.setSelectedItem(imp.palette);
                        ...
                        try {
                            ...
                            System.out.println(imp.date_emb);
                            System.out.println(imp.date_emb.substring(0,10));
                        ...
                        System.out.println(qte_modif+" sdgdfgdfgdgdfg "+rech_jtext.getText().toUpperCase());
                        ...
                        System.out.println("gghghfdjk"+imp.qte_tpe);
                        for (int i = rows - 1; i >= 0; i--) {
                            ((DefaultTableModel) tab.table.getModel()).removeRow(i);
                        }
...
//      cp.add(panel);
    ...
    public String action_date(){
        ...
        String aff=imp.afficher_conteur_tpe(date_picker.getDate(),chaine,"imp_emballage_tpe","PTR");
        ...
        code = "TPR" +chaine+ jour+ week + anne   + aff;
