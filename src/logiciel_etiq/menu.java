...
public class menu extends JFrame{
   ...
   // private JMenuItem imp_cod = new JMenuItem("Fiche Suiveuse");
    ...
    private  JMenu televisseur= new  JMenu("Etiquette T�l�viseur");
    ...
    private JMenuItem rech_detail = new JMenuItem("Recherche detaill�");
	...
	private  JMenuItem cod_ref= new  JMenuItem("Code r�f�rence");
	...
	public menu(final String logi_prio ) {
		  this.addWindowListener(new WindowAdapter(){
		   ...
		   int reponse = JOptionPane.showConfirmDialog(
	                null, "Voulez-vous quitter d�finitivement l'application ?",
	                "Confirmation",
...
//			fra.setVisible(true);
	   ...
	   msg=new JLabel("<HTML> Bienvenue "+logi_prio +", <br> veuillez entrer tout les information n�cessaire.</HTML>");
