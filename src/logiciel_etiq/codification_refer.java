         ...
         // gestion de l'action
          ...
          if (e.getActionCommand().equals(CTRL_J)){
        	  LineBorder border = new LineBorder ( Color.white, 1, true );
           	 TitledBorder titl2 = new TitledBorder ( border, "Edition r�f�rence", TitledBorder.DEFAULT_POSITION,
...
private JLabel lab_combo=new JLabel("Liste des r�f�rences");
private  jcombo refer_comb;

private JLabel refer_lab=new JLabel("Chiffre de r�f�rence");
...
public void composant(){
	list_ref= new ArrayList<String>(Arrays.asList(new String[]{"---Selectionner une r�f�rence-----"}));
...
valid_modif.setVisible(false);
    ...
    but_sup.addActionListener(
    	 ...
    	 //  System.out.println("dddddd"+existe);
           ...
           if(existe==false){
            	JOptionPane.showMessageDialog(null, "Cette r�f�rence n'existe pas", "",
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               // ref.reference(designation.getText());
            	   ...
            	   if(refer_comb.getSelectedIndex()==0){
	      				msg+="Vous Devez D'abord Selectionner une r�f�rence \n";
                      }
            	   else if(existe==false){msg+="Cette R�f�rence n'existe pas \n";}
            	if(!msg.equals("")){
    ...
    designation.setText("");
  	...
  	refer_comb.addItem("---Selectionner une r�f�rence-----");
	list_refer_tr=ref.select_reference_code();
...
//               else{
  	...
  	valid_modif.addActionListener(
	            ...
	            public void actionPerformed(ActionEvent e) {
	            	   ...
	            	   desc=false;
	            	   if(refer_comb.getSelectedIndex()==0){
	        	      				msg+="Vous Devez D'abord S�lectionner une r�f�rence\n";
	                   }
	            	 	...
	            	 	if(!msg.equals("")){
	    	            	...
	    	            	ref.setupdate_reference(creference.getText(), designation.getText());
	    	            	 JOptionPane.showMessageDialog(null,"La r�f�rence a �t� bien modifier");
	   	    	             designation.setText("");
	    	            		refer_comb.removeAllItems();
	    	            	  	 refer_comb.addItem("---Selectionner une r�f�rence-----");
	    	            	 	list_refer_tr=ref.select_reference_code();
  	 ...
  	 but_sauv.addActionListener(
             ...
             public void actionPerformed(ActionEvent e) {
                ...
                // ref.reference(designation.getText());
                 ...
                 if(existe==true){
                 	 JOptionPane.showMessageDialog(null, "Cette r�f�rence existe d�ja", "",
                 	 JOptionPane.INFORMATION_MESSAGE);
                 	   but_sauv.setVisible(false);
   ...
   valid_ajou.addActionListener(
           ...
           public void actionPerformed(ActionEvent e) {
        	   ...
        	   desc=false;
        	 	...
        	 	else if (existe==true) {msg+="Cette r�f�rence existe d�ja \n";}
        	 	else{
        	   ...
        	   refer_comb.removeAllItems();
                ...
                if(desc==false&&existe==false){
             	   JOptionPane.showMessageDialog(null,"La r�f�rence a �t� bien ajouter");
             	   refer_comb.enable();
                   designation.setText("");
                }
   ...
   designation.addActionListener(
    ...
    setTitle("Gestion des R�f�rences" );
    setSize(1000, 600);
