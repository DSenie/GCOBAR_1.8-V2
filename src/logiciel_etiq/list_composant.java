...
public class list_composant extends JFrame {
	/**
	 * 
	 */
    ...
    Object [] entete={"Code Carton","Code/Designation","R�ference","Serie Bobine","Quantit� par Bobine"};
    ...
    JLabel count=new JLabel("00");    JLabel qte_carton=new JLabel("00") ;
	...
	list_composant(final String log){
	   ...
	   public void composant(){
		   ...
		   dimension_comb.addItem("--- S�lectionner la dimension de l'etiquette ----");
			...
			//  imp.select_portable();
			  list_fiche=imp.select_composant();
	                  ...
	                  public void actionPerformed(ActionEvent e) {
	                	   att = new Thread(){
		  					...
		  					try {
		  						Date actuelle=new Date();
			 	                  DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
			 					   date_jour = dateFormat.format(actuelle);
			 	          			...
			 	          			String parcour="C://GCOBAR//pdf//excel//etiquette_composant"+date_jour+".xlsx";
		 	        			...
		 	        			cellA1.setCellValue("Code Carton");
		 	        			...
		 	        			Cell cellA = row1.createCell((short) 1);
		 	        			cellA.setCellValue("Code Article");
		 	        			cellStyle.setFillForegroundColor(HSSFColor.LIGHT_CORNFLOWER_BLUE.index);
		 	        			cellStyle.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);
		 	        			...
		 	        			cellB4.setCellValue("Serie Bobine");
		 	        			cellStyle = worksheet.createCellStyle();
		 	        			cellStyle.setFillForegroundColor(HSSFColor.LIGHT_CORNFLOWER_BLUE.index);
		 	        			cellStyle.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);
		 	        			...
		 	        			cellB5.setCellValue("Qte par Bobine");
		 	        			cellStyle = worksheet.createCellStyle();
		 	        			cellStyle.setFillForegroundColor(HSSFColor.LIGHT_CORNFLOWER_BLUE.index);
		 	        			cellStyle.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);
		 	        		...
		 	        		worksheet.write(fileOut);
	 			          	fileOut.close();
	 			          	fileOut.flush();
	  					    BufferedReader bfr=	new BufferedReader(new FileReader("C://GCOBAR//pdf//excel//etiquette_composant"+date_jour+".xlsx"));
	  					     bfr.close();		
	  						 					try {
	  		            	 Desktop.getDesktop().open(new File( "C://GCOBAR//pdf//excel//etiquette_composant"+date_jour+".xlsx"));
		     ...
		     menuItem.addActionListener(
	                  ...
	                  public void actionPerformed(ActionEvent e) {
	                	  ...
	                	  System.out.println("dddfdfsgh"+z);
		   		    		...
		   		    		if(!listserie.contains((String) tab.table.getValueAt(selection[i], 3)))
		   		    			listserie.add((String) tab.table.getValueAt(selection[i], 3));
		   		    	   }
		   		    	    
		   		    	   
		   		    	    System.out.println(listrc+"size"+listrc.size());
	                	  if(selectedRow!=-1){
	                		  String parcour= "C:\\GCOBAR\\pdf\\etq_composant\\"+dimension_comb.getSelectedItem().toString()+listrc.get(0)+"_"+z+"_"+"etq_composant.pdf";
								String model ="C:\\GCOBAR\\CODE\\"+report;
	                		  try{

                            new BufferedReader(new FileReader("C:\\GCOBAR\\pdf\\etq_composant\\"+dimension_comb.getSelectedItem().toString()+listrc.get(0)+"_"+z+"_"+"etq_composant.pdf"));
	                			  try {
	    	                		  Desktop.getDesktop().open(new File("C:\\GCOBAR\\pdf\\etq_composant\\"+dimension_comb.getSelectedItem().toString()+listrc.get(0)+"_"+z+"_"+"etq_composant.pdf"));
	                	  ...
	                	  selectioncomb.imprimer_deux("code_carton_parm",listrc,"serie_parmetre",listserie,bdd,parcour,model);
	                	  listrc.clear(); 
	                	  listserie.clear(); 
		                		  ...
		                		  JOptionPane.showMessageDialog(null, "Vous devez choisir un type d'�tiquette");
		                	  }
	                  }});
