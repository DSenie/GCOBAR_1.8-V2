...
public class list_palette_tablette extends JFrame {
    /**
     *
     */
    ...
    Object [] entete={"Code/Designation","Palette","Parcel","SN"};
    ...
    public list_palette_tablette(final String log){
        ...
        list_dimension=imp.select_dimension_etq("etq_tablette_palette");
        ...
        dimension_comb.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                if(dimension_comb.getSelectedIndex()!=0)
                    report=imp.select_report(dimension_comb.getSelectedItem().toString(),"etq_tablette_palette");
            }});
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if(dimension_comb.getSelectedIndex()!=0){
                            ...
                            for (int i=0; i<z; i++) {
                                ...
                                if (!listserial.contains(tab.table.getValueAt(selection[i], 3)))
                                    listserial.add((String) tab.table.getValueAt(selection[i], 3));
                            }



                            int j=listserial.size();


                            if(selectedRow!=-1){

                                String parcour= "C:\\GCOBAR\\pdf\\palette_tpe\\"+dimension_comb.getSelectedItem()+listserial.get(0).toString().replaceAll("\\/", "_")
                                        +"_"+listserial.get(j-1).toString().replaceAll("\\/", "_")+"_"+z+"_"+".pdf";
                                ...
                                try{
                                    ...
                                    parameters.put("serial",listserial);
                            ...
                            public void run(){
                                ...
                                if (reponse==JOptionPane.YES_OPTION){
                                    try {
                                        ...
                                        String parcour="C://GCOBAR//pdf//excel//tablette_emballage"+date_jour+".xlsx";
...
//
                                        ...
                                        fileOut.close();
                                        fileOut.flush();
                                        BufferedReader bfr=	new BufferedReader(new FileReader("C://GCOBAR//pdf//excel//tablette_emballage"+date_jour+".xlsx"));
                                        bfr.close();
                                        try {
                                            Desktop.getDesktop().open(new File( "C://GCOBAR//pdf//excel//tablette_emballage"+date_jour+".xlsx"));
    ...
    private void recherche(){
        ...
        list_rech=imp.recherche_palette_tablette(filtre, datedebut, datefin);
        ...
        //list_rech=imp.select_emei_table(filterText.getText());
        for(int i1=0;i1<list_rech.size();i1=i1+5){ tab.ajouter();}
        int j1=1;
        int l1 = 0; i1=1;
        ...
        countpalette.setText("Nombre de Palette  :"+imp.nbr_palette_tablette(filtre, datedebut, datefin));
        countcarton.setText("Nombre de Carton  :"+imp.nbr_carton_tablette(filtre, datedebut, datefin));
