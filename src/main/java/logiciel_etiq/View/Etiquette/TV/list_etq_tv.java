...
public class list_etq_tv extends generale {


    private Object [] entete={"Code/Designation Article","Chaine","Date","serial_number","code_commercial"};
    ...
    public list_etq_tv (final String log){
        build(tab,popupMenu);
        composant(log);}
    ...
    public void composant(String log){
        ...
        initFrame("Liste des Etiquette TV", panel, this, log,"Liste des Etiquette TV");
        ...
        exporter.addActionListener(
                e -> generateExcel("list_etq_tv","Liste des etiquette TV",  tab, entete,  selectedRow));
    ...
    private void recherche() {
        ArrayList list_fiche=imp_tv.select(filterText.getText(),datedebutText.getDate(),datefinText.getDate());
