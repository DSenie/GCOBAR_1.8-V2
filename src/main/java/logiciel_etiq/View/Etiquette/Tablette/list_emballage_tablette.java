...
public class list_emballage_tablette extends generale {

    private Object [] entete={"Palette","Parcel","Code/Designation","Date emballage","GW","Quantité","Serial Number", "Commentaire"};
    ...
    public list_emballage_tablette(final String log){
    ...
    public void composant(String log){
        ...
        initFrame("Liste des Etiquette Emballage Tablette", panel, this, log,"Liste des Etiquette Emballage Tablette");
        ...
        imprimer.addActionListener(
                e -> {
                    if (dimension_comb.getSelectedIndex() == 0) {
                        ...
                        if (selectedRow != 0) {
                            String parcour = constant.etiq_tablette + dimension_comb.getSelectedItem()+ tab.table.getSelectedRowCount() + "_" + "etq_emballage_tablette.pdf";
        ...
        exporter.addActionListener(
                e -> generateExcel("list_etq_tablette_emballage","Liste des etiquette Tablette emballage",  tab, entete,  selectedRow));
   ...
   private void recherche_tablette(){
       ArrayList list_fiche=imp_tablette.select_tablette(filterText.getText(),datedebutText.getDate(),datefinText.getDate());
       remplirTab(list_fiche, 8,  tab,0);

       count_palette.setText("Nombre Palette : " +imp_tablette.nbr_palette_tablette(filterText.getText(),datedebutText.getDate(),datefinText.getDate(),"parcel_palette" ));
       count_carton.setText("Nombre Carton : " +imp_tablette.nbr_palette_tablette(filterText.getText(),datedebutText.getDate(),datefinText.getDate(),"parcel"));
