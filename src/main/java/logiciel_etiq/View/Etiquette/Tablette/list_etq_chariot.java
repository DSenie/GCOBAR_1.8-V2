...
public class list_etq_chariot extends generale {
    ...
    public list_etq_chariot(final String log){
    ...
    public void composant(String log){
        ...
        initFrame("Liste des Etiquette Chariot", panel, this, log,"Liste des Etiquette Chariot");
        ...
        imprimer.addActionListener(
                e -> {
                    if (dimension_comb.getSelectedIndex() == 0) {
                        ...
                        if (selectedRow != 0) {
                            String parcour = constant.etiq_tablette + dimension_comb.getSelectedItem() + tab.table.getSelectedRowCount() + "_" + ".pdf";
        ...
        exporter.addActionListener(
                e -> generateExcel("list_etq_chariot","Liste des etiquette Chariot",  tab, entete,  selectedRow));
