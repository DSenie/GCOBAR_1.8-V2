...
public class list_emballage_portable extends generale {

    private Object [] entete={"Parcel","Palette","Code/Designation","modèle","couleur","delivery","G.W","N.W","Carton Size","commentaire","Date","Imei1","Imei2"};
    ...
    public list_emballage_portable(final String log){
    ...
    public void composant(String log){
        ...
        initFrame("Liste des Etiquette Emballage Portable", panel, this, log,"Liste des Etiquette Emballage Portable");
                ...
                e -> {
                    if (dimension_comb.getSelectedIndex() == 0) {
                        JOptionPane.showMessageDialog(null, "Vous devez choisir un type d'étiquette"); }
                         ...
                         removeDoublant(tab,0);
                        if (selectedRow != 0) {
                            String parcour = constant.etiq_portable+ dimension_comb.getSelectedItem()+ tab.table.getSelectedRowCount() + "_" + "etq_emballage_portable.pdf";
        ...
        exporter.addActionListener(
                e -> generateExcel("list_etq_portable_emballage","Liste des etiquette Portable emballage",  tab, entete,  selectedRow));
   ...
   private void recherche_portable(){
       ArrayList list_fiche=imp_phone.select_portable(filterText.getText(),datedebutText.getDate(),datefinText.getDate());
       remplirTab(list_fiche, 13,  tab,0);

       count_palette.setText("Nombre Palette : " +imp_phone.nbr_palette_portable(filterText.getText(),datedebutText.getDate(),datefinText.getDate(),"parcel_palette" ));
       count_carton.setText("Nombre Carton : " +imp_phone.nbr_palette_portable(filterText.getText(),datedebutText.getDate(),datefinText.getDate(),"parcel"));
