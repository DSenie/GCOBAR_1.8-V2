...
public class list_etq_portable extends generale {


    private     Object [] entete={"Model","couleur","Imei1","Imei2","Date"};
    ...
    private gestion_imp_phone imp_tpe=new gestion_imp_phone();


    public list_etq_portable(final String log){
    ...
    public void composant(String log){
        ...
        initFrame("Liste des Etiquette Portable", panel, this, log,"Liste des Etiquette Portable");
        ...
        recherche_portable();
        rech_but.addActionListener(e ->   recherche_portable());
        ...
        imprimer.addActionListener(
                e -> {
                    if (dimension_comb.getSelectedIndex() == 0) {
                        ...
                        if (selectedRow != 0) {
                            String parcour = constant.etiq_portable + dimension_comb.getSelectedItem() + tab.table.getSelectedRowCount() + "_etiquette_portable.pdf";
        ...
        exporter.addActionListener(
                e -> generateExcel("list_etq_portable","Liste des etiquette Portable",  tab, entete,  selectedRow));
    ...
    ArrayList list_fiche=imp_tpe.select_etq_portable(filterText.getText(),datedebutText.getDate(),datefinText.getDate());
