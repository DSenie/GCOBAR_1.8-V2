...
public class list_etq_sn_tablette extends JFrame {
	/**
	 *
	 */
    ...
    Object [] entete={"Code","model","couleur","sn","Date"};
	...
	list_etq_sn_tablette(final String log) throws ParseException{
	   ...
	   public void composant() throws ParseException{
		   if(!selectioncomb.prv.contains("list_tablette_forn")){
			//System.out.println("list_fiche"+selectioncomb.prv);
			 selectioncomb.prv.add("list_tablette_forn");}
		   ...
		   dimension_comb.addItem("--- Sélectionner la dimension de l'etiquette ----");
			...
			list_dimension=imp.select_dimension_etq("etq_portable_forn_list");
			 ...
			 JPanel panel =new JPanel() {
			  ...
			  filterText.addFocusListener(
			     ...
			     //imp.select_etq_tablette();
			     list_fiche=imp.select_etq_tablette();
				...
				//	 System.out.println("ddddd"+list_fiche.get(l+4).toLowerCase());
				/*if(list_fiche.get(l+4)!=null)*/
             	...
             	//	System.out.println("ddddd"+date_i);
	   ...
	   private void build() {
		     ...
		     dimension_comb.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent event) {
						...
						report=imp.select_report(dimension_comb.getSelectedItem().toString(),"etq_portable_forn_list");
		     ...
		     menuItem.addActionListener(
	                  ...
	                  public void actionPerformed(ActionEvent e) {
	                	  ...
	                	  int z =selection.length;
		   		    	    for (int i=0; i<z; i++) {
		   		    		if(!listrc.contains((String) tab.table.getValueAt(selection[i], 3)))
		   		    	    listrc.add((String) tab.table.getValueAt(selection[i], 3));
		   		    	   }
	                	  if(selectedRow!=-1){
	                		  String parcour= "C:\\GCOBAR\\pdf\\etq_tablette_fournisseur\\"+dimension_comb.getSelectedItem()+listrc.get(0)+"_"+listrc.get(z-1)+"_"+z+"_"+"etq_fournisseur.pdf";
								String model ="C:\\GCOBAR\\CODE\\"+report;
	                		  try{

                            new BufferedReader(new FileReader("C:\\GCOBAR\\pdf\\etq_tablette_fournisseur\\"+dimension_comb.getSelectedItem()+listrc.get(0)+"_"+listrc.get(z-1)+"_"+z+"_"+"etq_fournisseur.pdf"));
	                			  try {
	    	                		  Desktop.getDesktop().open(new File("C:\\GCOBAR\\pdf\\etq_tablette_fournisseur\\"+dimension_comb.getSelectedItem()+listrc.get(0)+"_"+listrc.get(z-1)+"_"+z+"_"+"etq_fournisseur.pdf"));
	                  ...
	                  public void actionPerformed(ActionEvent e) {
	                	   att = new Thread(){
		  					...
		  					try {
		  						Date actuelle=new Date();
			 	                  DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
			 					   date_jour = dateFormat.format(actuelle);
			 	          			...
			 	          			String parcour="C://GCOBAR//pdf//excel//tablette_fournisseur"+date_jour+".xlsx";
								...
								Cell cellA0 = row1.createCell((short) 0);
								cellA0.setCellValue("Code");
		 	        		...
		 	        		worksheet.write(fileOut);
	 			          	fileOut.close();
	 			          	fileOut.flush();
	  					    BufferedReader bfr=	new BufferedReader(new FileReader("C://GCOBAR//pdf//excel//tablette_fournisseur"+date_jour+".xlsx"));
	  					     bfr.close();		
	  						 					try {
	  		            	 Desktop.getDesktop().open(new File( "C://GCOBAR//pdf//excel//tablette_fournisseur"+date_jour+".xlsx"));
