...
public class etiquette_tpe_2code extends JFrame {
    ...
    JTextField imei_jtext=new JTextField();
    ...
    etiquette_tpe_2code(final String log) {
    ...
    public void composant(final String logi_prio) {
        ...
        list_dimension=imp.select_dimension_etq("etq_tpe_2code");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(code_enie.equals("")) {
                    JOptionPane.showMessageDialog(
                     ...
                     ArrayList<String> tpe_liste=  imp.selection_3tpe_champ(code_enie,"",imei_jtext.getText());
                ...
                att= new Thread(){
                    public void run() {
                      //  String msg="";
                        ...
                        boolean existe;
                        existe=imp.exist_imei(imei_jtext.getText());
                        ...
                        if (msg.equals("")&&existe==false
                            ...
                            imp.insert_Tpe_3Code(code_enie_jtext.getText(),"", imei_jtext.getText(), chaine,code_article,date_picker.getEditor().getText());
            ...
            public void actionPerformed(ActionEvent e) {
                att= new Thread(){
                    public void run() {
                        ...
                        boolean existe;
                        existe=imp.exist_tpe_modif_2code(imei_jtext.getText(), code_enie_jtext.getText());
                        ...
                        if (msg.equals("")&&existe==false) {
                          ...
                          imp.update_tpe_3code("", imei_jtext.getText(), code_article, code_enie_jtext.getText() );
        ...
        dimension_comb.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                if(dimension_comb.getSelectedIndex()!=0)
                    report=imp.select_report(dimension_comb.getSelectedItem().toString(),"etq_tpe_2code");
    ...
    public void sn_imei_action(){
        ...
        boolean existe=imp.exist_imei(imei_jtext.getText());

        if(existe==true){
           ArrayList<String> tpe_liste= imp.selection_3tpe_champ(code_enie_jtext.getText(),"",imei_jtext.getText());
