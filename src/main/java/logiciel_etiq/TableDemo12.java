 ...
 */
public class TableDemo12 extends JPanel {
            ...
            public MoveButton(String name, int code,
                ...
                this.setAction(new AbstractAction(this.getText()) {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        TableDemo12.this.p1.translate(dx, dy);
                        TableDemo12.this.p2.translate(dx, dy);
                        TableDemo12.this.repaint();
                    }
                });
