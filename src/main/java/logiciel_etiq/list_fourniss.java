...
public class list_fourniss extends JFrame{
	/**
	 * 
	 */
	private ArrayList <String>list_fourniss= new ArrayList<String>() ;
...
list_fourniss(final String log){ 
...
public void composant(){
	 selectioncomb.prv.add("list_fourniss");
    ...
    tab.setStyle(2);
	 ...
	 tab.setStyle(2);
	  ...
	  filterText.addKeyListener(new KeyAdapter() {
	      public void keyReleased(KeyEvent e) {
             ...
             tab.sorter.setRowFilter(null);
              ...
              System.out.println("rrr "+tab.table.getRowCount());
				 count.setText("Le Nombre Des fournisseur:  "+tab.table.getRowCount());
	  ...
	  filterText.addFocusListener(
	   ...
	   //  forn.select();
	     list_fourniss=forn.select();
	    for(i=0;i<list_fourniss.size();i=i+2){tab.ajouter();}
		int j=1;
		int l = 0; i=1;
		while(l<list_fourniss.size()){
		
		 while(l<j*2){
			 tab.getTable().setValueAt(list_fourniss.get(l).toLowerCase(), j-1, i-1);
			 i=i+1; l=l+1;
		 }
		 i=1;
		j=j+1;		
    ...
    tab.table.setFont(police_fi);
	    ...
	    count = new JLabel("Le Nombre Des fournisseur:  "+tab.table.getRowCount());
    ...
    setTitle("Consultation Fournisseurs" );
    setSize(1000, 600);
