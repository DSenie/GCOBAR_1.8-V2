...
public class menu extends JFrame{
   ...
   private JMenuItem etq_palette_tablette_list = new JMenuItem("Recherche Détaillée Tablette");
    ...
    private JMenuItem rech_detail = new JMenuItem("Recherche detaillée");
...
//	    Image img = kit.getImage(getClass().getClassLoader().getResource("icon.png"));
	   ...
	   msg=new JLabel("<HTML> Bienvenue "+logi_prio +", <br> veuillez entrer tout les information nécessaire.</HTML>");
        ...
        //  jMenuBar.add(fiche);
          ...
          if(resultat.get(28).equals("TRUE"))
          jMenuBar.add(prof);
          prof.add(edit_prof);
/******************************************************/
        //  jMenuBar.add(tache);
      ...
      //if(resultat.get(0).equals("TRUE"))
       //jMenuBar.add(poste);

        // if(resultat.get(2).equals("TRUE"))
         //jMenuBar.add(zone);

         if(resultat.get(1).equals("TRUE"))
         jMenuBar.add(chaine);



		 /* if(resultat.get(3).equals("TRUE"))
           jMenuBar.add(perso);
     ...
     //   jMenuBar.add(compo);
		...
		/*if(resultat.get(14).equals("TRUE"))
         poste.add(edit_poste);
 		if(resultat.get(15).equals("TRUE"))
         poste.add(list_poste);
*/

      //   compo.add(edit_comp);
   /*    if(resultat.get(29).equals("TRUE"))
        zone.add(zon_edit);
       if(resultat.get(30).equals("TRUE"))
         zone.add(zon_consu);
*/

         if(resultat.get(16).equals("TRUE"))
         chaine.add(chai_edit);

         if(resultat.get(18).equals("TRUE"))
        chaine.add(chang_chaine);
         if(resultat.get(17).equals("TRUE"))
          chaine.add(list_chaine);
       /* if(resultat.get(19).equals("TRUE"))
          perso.add(perso_edit);
         if(resultat.get(20).equals("TRUE"))
          perso.add(perso_consu);*/
          //jMenuBar.add(prfini);

        System.out.println("eeeeee "+resultat.get(4));
     ...
     if(use.admin(logi_prio)==true){
        ...
        if(resultat.get(4).equals("TRUE"))
          jMenuBar.add(util);
        if(resultat.get(21).equals("TRUE"))
          util.add(edit);
        if(resultat.get(22).equals("TRUE"))
          util.add(edit1);
          }
          if(resultat.get(13).equals("TRUE"))
          jMenuBar.add(fourniss);

          if(resultat.get(24).equals("TRUE"))
          fourniss.add(fourniss_edit);
          if(resultat.get(25).equals("TRUE"))
          fourniss.add(fourniss_consu);

  		  if(resultat.get(5).equals("TRUE"))
          jMenuBar.add(codification);
          if(resultat.get(6).equals("TRUE"))
          codification.add(cod_ref);
          if(resultat.get(7).equals("TRUE"))
          codification.add(cod_gener);

          if(resultat.get(23).equals("TRUE"))
          codification.add(rech);
          if(resultat.get(8).equals("TRUE"))
          jMenuBar.add(article);

          if(resultat.get(9).equals("TRUE"))
          article.add(famille_art);

          if(resultat.get(26).equals("TRUE"))
          article.add(article_edit);
          if(resultat.get(10).equals("TRUE"))
          jMenuBar.add(imp);
