...
//		}
		...
		palette_ajou.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String aff=imp.afficher_conteur_palette("PP",chaine_comb.getSelectedItem().toString().substring(2,3));
		...
		valid_supp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (rech_jtext.getText().trim().equals("")) {
					...
					imp.supprimer_carton("imp_emballage","emei_table",parcel_jtext.getText());
...
//				use.select_zone_jtext(designation.getText());
		...
		but_sup.setPreferredSize(new Dimension(160, 33));
        valid_supp.setPreferredSize(new Dimension(160, 33));
...
//		cp.add(panel);
   ...
   /* public void parcelNum(){
    ...
    public String action_date(){
         int size=chaine_comb.getItemCount()-1;
    	if(chaine_comb.getSelectedIndex()!=size)
        ...
        String aff=imp.afficher_conteur_tpe(date_picker.getDate(),chaine,"imp_emballage","PP");
        ...
        code = "MF" +chaine+ jour+ week + anne   + aff;
