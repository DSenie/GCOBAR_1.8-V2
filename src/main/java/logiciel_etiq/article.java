...
public class article extends JFrame  implements ActionListener{
	...
	private JLabel ref_lab_combo=new JLabel("Chiffre réfèrence");
 	   ...
 	   if(enie.isSelected()==true){fabr="enie";}
	     ...
	     for(int i=0;i<list_article_tr.size();i++)
	      ...
	      article_comb.setWide(true);
		   ...
		   list_r = new ArrayList<String>(Arrays.asList(new String[]{"---Selectionner une réfèrence-----"}));
		...
		valid_modif.addActionListener(
	            ...
	            public void actionPerformed(ActionEvent e) {
	            	  if(tab.table.getCellEditor()!=null){
		        	   ...
		        	   if(famille_comb.getSelectedIndex()!=0){
		        		   // part2 = famille_comb.getSelectedItem().toString().substring(4);
		            	    ...
		            	    System.out.println("teste de composant "+part2);
		        	   }
		 	    	 ...
		 	    	 if (enie.isSelected()&&(codegener_comb.getSelectedIndex()==0||ref_comb.getSelectedIndex()==0)){
		                	 ...
		                	 else if(ref_comb.getSelectedIndex()==0||ref_comb.getSelectedIndex()==-1){msg+="Veuillez selectionner une réfèrence \n";}
	             		  }
    			           ...
    			           public void actionPerformed(ActionEvent e) {
							   ...
							   if(famille_comb.getItemCount()>=1){
    			        		remplir_art_table();
								   ...
								   System.out.println(" ppppppp "+famille_comb.getEditor().getItem().toString());
